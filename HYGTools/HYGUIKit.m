...
+ (HYGButton *)buttonWithBackgroundColor:(UIColor *)backgroundColor
    ...
    HYGButton * button = [HYGButton buttonWithType:UIButtonTypeCustom];
...
+ (YGTextField *)textFieldWithBackgroundColor:(UIColor *)backgroundColor
    ...
    YGTextField * textField = [YGTextField new];
